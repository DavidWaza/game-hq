  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
      <div className="bg-white rounded-xl p-8 shadow-2xl max-w-md w-full text-center transform transition-all duration-300 scale-100 animate-fade-in">
        ...
        <div className="flex justify-center items-center mb-5 border-b-2 border-[#FB5D12] rounded-full w-20 h-20 mx-auto bg-[#233D4D]">
          <Envelope
            size={40}
            className="text-[#FB5D12] "
          />
        </div>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <Button variant="secondary" size="lg" width="full" onClick={onClose}>
            Close
          </Button>
        </div>
      </div>
