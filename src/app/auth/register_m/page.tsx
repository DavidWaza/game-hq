...
const RegisterUser: React.FC = () => {
  ...
  return (
    <div>
      ...
      <div className="lg:p-24 relative">
        <div className="card-two bg-gradient-to-br from-[#233d4d] via-[#2c586b] to-[#101820] mx-auto flex justify-center h-[40rem]">
          <div className="grid lg:grid-cols-3">
            ...
            <div className="col-span-2">
              ...
              <Image
                ...
                height={0}
                sizes="100vw"
                className="w-2/3 mr-0 ml-auto h-auto object-contain object-center"
              />
            </div>
          </div>
        </div>
