...
const MobileRegister = () => {
  ...
  return (
    <div className="relative block md:hidden sm:h-dvh overflow-auto">
      <div className="bg-gradient-to-br from-[#233d4d] via-[#2c586b] to-[#101820] mx-auto justify_auto h-full relative">
        <div className="max-h-max relative z-10">
          <h1 className="text-[#fcf8db] md:text-6xl text-4xl md:py-32 py-5 px-5">
            Start your Journey...
          </h1>
        </div>
        <div className="overflow-y-auto">
          <div className="relative z-20 min-h-full flex_center">
            <div className="px-4 py-5 sm:py-4 w-full">
                    ...
                    <div className="grid w-full items-center gap-1.5">
                      ...
                      <div className="relative">
                        ...
                        <button
                          ...
                          onClick={() => setIsVisible_mobile(!isVisible_mobile)}
                        >
                          {isVisible_mobile ? (
                    ...
                    <div className="grid w-full items-center gap-1.5">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          type={confirmIsVisible_mobile ? "text" : "password"}
                          id="confirm_password"
                        ...
                        <button
                          ...
                          className="absolute top-1/2 -translate-y-1/2 right-2"
                          onClick={() =>
                            setConfirmIsVisible_mobile(!confirmIsVisible_mobile)
                          }
                        >
        ...
        <Image
          ...
          className="w-full h-auto object-contain object-center absolute bottom-0 right-0"
        />
      </div>
    </div>
  );
