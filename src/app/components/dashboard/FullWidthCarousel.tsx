...
const Carousel = () => {
  ...
  return (
    <div className="relative w-full h-dvh">
      <div className="container absolute bottom-0 left-0 right-0 w-full px-4 m-auto h-full overflow-hidden">
        <div className="absolute z-20 bottom-10 md:bottom-20 left-0 w-full bg-cover bg-center">
          <div className="grid grid-cols-1 gap-2 md:gap-4 px-5 lg:w-[25%] ml-auto space-y-5">
            {/* Create Wager */}
            <button
        ...
        {slides.map((slide, index) => (
          <SwiperSlide key={index}>
            <div className="relative w-full h-full overflow-hidden flex items-center justify-center">
              ...
              <div className="absolute inset-0 flex h-full w-full items-center justify-center bg-black/50 text-center">
                ...
                <AnimatePresence mode="popLayout">
                  <motion.div
                    ...
                    className="relative flex items-center justify-center container mx-auto px-4"
                  >
                    <motion.h2
                      key={currentIndex}
                      initial={{ opacity: 0 }}
